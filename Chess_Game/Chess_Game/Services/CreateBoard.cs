    ...
    public class CreateBoard
    {
        ...
        public IPiece[,] Create()
        {
            IPiece[,] table =
            {
                ...
                { new BoardCoordinates("8"), new Tower(false), new Horse(false), new Bishop(false), new Queen(false), new King(false), new Bishop(false), new Horse(false), new Tower(false) },
